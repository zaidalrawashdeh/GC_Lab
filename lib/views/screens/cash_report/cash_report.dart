...
import '../../../widgets/cash_table.dart';
...
class _CashReportState extends State<CashReport> {
  ...
  List<Map<String, dynamic>> convertApiResponseToList(
    ...
    // Assuming your API response contains a list under the key 'AllTestsList'
    if (apiResponse.containsKey('CashList') &&
        apiResponse['CashList'] is List) {
      List<dynamic> data = apiResponse['CashList'];
  ...
  Future<void> CashReportTable({String id_branch = "0"}) async {
    if (startDate != null) {
      setState(() {
        isLoading = true;
      });
      showDialog(
        ...
        builder: (context) {
          return AlertDialog(
            ...
            backgroundColor: Color.fromARGB(255, 182, 34, 55),
          );
        },
      );
  ...
  Future<void> _downloadAsPDF(BuildContext context) async {
    ...
    final rowsPerPage = 13; // Number of rows to display per page
    ...
    final String filePath = '$tempPath/Cash_Report.pdf';
          ...
          children: [
                    ...
                    onSubmit: (value) {
                      setState(() {
                        if (value.isNotEmpty &&
                          ...
                          CashReportTable(id_branch: "0");
                        } else {
                          branches = value;
                          branch_ID = branchNameToBrSeqMap[branches];
                          CashReportTable(id_branch: branch_ID);
                          log("$branch_ID");
                        }
                      });
                    },
            ...
            Container(
              ...
              child: SingleChildScrollView(
                ...
                child: Column(
                  children: [
                    CashTable(data: foundPatients, t1: t1),
                  ],
                ),
              ),
            ),
