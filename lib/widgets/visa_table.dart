...
class VisaTable extends StatefulWidget {
  final List<List<String>> data;
  final double t1;
  const VisaTable({super.key, required this.data, required this.t1});

  @override
  State<VisaTable> createState() => _VisaTableState();
}

class _VisaTableState extends State<VisaTable> {
